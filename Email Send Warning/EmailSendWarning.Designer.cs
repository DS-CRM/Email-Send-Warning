...
namespace EmailSendWarning {
    ...
    public sealed partial class EmailSendWarning : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        public EmailSendWarning(global::Microsoft.Office.Tools.Outlook.Factory factory, global::System.IServiceProvider serviceProvider) : 
                base(factory, serviceProvider, "AddIn", "EmailSendWarning") {
    ...
    internal sealed partial class Globals {
        ...
        private static EmailSendWarning _EmailSendWarning;
        ...
        internal static EmailSendWarning EmailSendWarning {
            get {
                return _EmailSendWarning;
            }
            set {
                if ((_EmailSendWarning == null)) {
                    _EmailSendWarning = value;
                }
                else {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.EmailSendWarning.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionCollectionBase {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return ((WindowFormRegionCollection)(Globals.EmailSendWarning.GetFormRegions(explorer, typeof(WindowFormRegionCollection))));
            }
        }
        
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Inspector inspector] {
            get {
                return ((WindowFormRegionCollection)(Globals.EmailSendWarning.GetFormRegions(inspector, typeof(WindowFormRegionCollection))));
            }
        }
    }
